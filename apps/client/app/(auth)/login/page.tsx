  ...
  return (
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-[var(--muted-foreground)] mt-1">Split expenses. Stay friends.</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-[var(--muted-foreground)]">
        ...
        <Link href="/register" className="text-brand font-medium hover:text-brand-dark">Sign up</Link>
      </p>
    </div>
  );
}
